<script lang="ts">
    ...
    import type { InvoiceCreate, Client, Product } from "$lib/utils/types";
    ...
    import FilePlusIcon from "@tabler/icons-svelte/icons/file-plus";
    import Loader2Icon from "@tabler/icons-svelte/icons/loader-2";
    import PlusIcon from "@tabler/icons-svelte/icons/plus";
    import TrashIcon from "@tabler/icons-svelte/icons/trash";

    let { onInvoiceCreated }: { onInvoiceCreated: () => void } = $props();
    ...
    <Dialog.Content class="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <Dialog.Header>
            <Dialog.Title class="flex items-center gap-2">
                <FilePlusIcon class="h-5 w-5 text-primary" />
                Create New Invoice
            </Dialog.Title>
            <Dialog.Description>
                Create a new invoice for a client. Fill in all required fields.
            </Dialog.Description>
        </Dialog.Header>
